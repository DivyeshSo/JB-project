...
const ViewApplications = () => {
  ...
  <div className='flex items-center justify-center h-[70vh]'>
    <p className='text-xl sm:text-2xl'> No Applicayions Available </p> 
    </div>
  ) : (
        ...
        <table className='w-full max-w-4xl bg-white border border-gray-200 max-sm:text-sm'>
          <thead>
            <tr className='border-b'>
              <th className='py-2 px-4 text-1.4xl text-left'>#</th>
              <th className='py-2 px-4 text-1.4xl text-left'>User name</th>
              <th className='py-2 px-4 text-1.4xl text-left max-sm:hidden'>Job Title</th>
              <th className='py-2 px-4 text-1.4xl text-left max-sm:hidden'>Location</th>
              <th className='py-2 px-4 text-1.4xl text-left'>Resume</th>
              <th className='py-2 px-4 text-1.4xl text-left'>Action</th>
            </tr>
          </thead>
          <tbody>
